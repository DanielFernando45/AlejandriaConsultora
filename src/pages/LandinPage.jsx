      ...
      <main className="overflow-hidden ">
        <section className='h-[500px] sm:h-[600px] md:h-[800px] 1xl:h-[1117px] relative'>
          <div className="bg-[#1C1C34]  text-white   z-10 h-full w-full flex justify-center  ">
            <div className="text-center  absolute top-32 mn:top-40 sm:top-52 px-7">
              ...
              <p className="text-[9px] uppercase mb-[20px] sm:text-[22px] lg:text-[28px] xl:text-[32px] 1xl:text-[48px] 4xl:text-[53px] font-semibold italic">
                Contamos con +5000 aprobados en 11 años de experiencia
              </p>
              <p className="text-[9px] sm:text-[13px] md:text-[15px] xl:text-[21px] ">📌<span className="font-semibold">Mira este video hasta el final</span>  y descubre los recursos que ofrecemos para ayudarte en tu tesis</p>
            </div>
            <div className="bg-white absolute top-[220px] mn:top-[240px] sm:top-[350px] lg:top-[370px] xl:top-[380px]
             w-[250px] mn:w-[290px] sm:w-[480px] md:w-[650px] xl:w-[900px] h-[140px] mn:h-[180px] sm:h-[320px] md:h-[390px] xl:h-[520px]">
            </div>

            <div className="absolute top-[400px] mn:top-[440px] sm:top-[700px] md:top-[800px] xl:top-[970px] w-full px-3">
              <button
                data-aos="fade-up"
                data-aos-offset="300"
            ...
            <div className="absolute top-[470px] mn:top-[510px] sm:top-[800px] md:top-[900px] xl:top-[1100px] ">

              <div className="flex w-full justify-center gap-9 text-[30px] sm:text-[40px] md:text-[60px] font-bold">
                <div className="flex flex-col items-center  w-[50px] mn:w-[120px]">
                  <p >00</p>
                  <p className="text-[10px] sm:text-[15px] md:text-[20px] font-normal text-center">Hora</p>
                </div>
                <div className="flex flex-col items-center w-[50px] mn:w-[120px]">
                  <p >00</p>
                  <p className="text-[10px] sm:text-[15px] md:text-[20px] font-normal text-center">Minutos</p>
                </div>
                <div className="flex flex-col items-center  w-[50px] mn:w-[120px]">
                  <p >00</p>
                  <p className="text-[10px] sm:text-[15px] md:text-[20px] font-normal text-center">Segundos</p>
                </div>
              </div>

              <p className="text-[9px] sm:text-[13px] md:text-[15px] xl:text-[21px] mt-5 xl:mt-14 italic px-3 text-center">“No sabía por dónde empezar. Con la Biblia del Tesista avancé más en una semana que en tres meses.”
                — Camila R.</p>
        ...
        <section >
          <div className="bg-[#1C1C34] pt-[93px] mn:pt-[133px] sm:pt-[440px] md:pt-[300px] xl:pt-[600px]">
            ...
            <div className="mb-20 w-[98%] mn:w-[339px] h-[373px] sm:w-[520px] md:w-full md:px-10  lg:w-[880px] xl:w-[1250px] 1xl:w-[1241px] 4xl:w-[1569px] sm:h-[563px] lg:h-[600px] 1xl:h-[402px] 4xl:h-[444px] 1xl:items-center flex flex-col 1xl:flex-row mx-auto  1xl:gap-x-[50px] gap-y-[20px]">

              <p className="text-white font-semibold text-[14px] sm:text-[30px] lg:text-[38px] xl:text-[45px] 4xl:text-[45px] text-center">
              ...
              <div className="flex flex-col text-white gap-5 xl:flex-row">
                ...
                <div className="w-full flex justify-center">
                  <img className="w-[200px] mn:w-[220px] sm:w-[400px] md:w-[450px] h-[250px]  mn:h-[270px] sm:h-[500px] md:h-[600px] "
                    src={tesis} alt=""
                  />
                </div>
                <div className="flex flex-col lg:gap-10 lg:justify-center">
                  <div className=" px-5">
                    <div className="flex flex-col  xl:items-start">
                      <p className="text-[18px] sm:text-[30px] md:text-[42px] text-center">La Bilbia del Tesista</p>
                      <p className="text-center sm:text-[20px] md:text-[25px] xl:text-[33px]">Un <spam className="text-[#0CB2D5] ">faro</spam>  para tu camino académico</p>
                    </div>
                    <div className="mt-7 font-medium text-[10px] mn:text-[12px] sm:text-[18px] md:text-[20px] lg:text-[25px] ">
            ...
            {/*  */}
            <div className="digital pt-[100px] pb-[2px]  1xl:pb-[400px] mt-[800px] sm:mt-[1060px] md:mt-[1300px] xl:mt-[700px]">
              ...
              <div className="space-y-[47px] w-[95%] mn:w-auto mx-auto ">
                ...
                <div className="font-bold px-10  sm:text-[16px] md:text-[20px] xl:text-[28px] md:px-16 xl:px-20 ">
              ...
              <div className="mx-auto text-center mt-[50px] sm:mt-[120px] lg:mt-[250px] mb-[50px]">
                ...
                <div className="flex flex-col items-center mx-5 mt-5 xl:mt-20 gap-4 xl:flex-row">
                  ...
                  <div className="testi p-2">
                    <img className="rounded-[20px]" src={testimonioTree} alt="" />
                  </div>
                </div>
              </div>
            ...
            <div className="hotmart pb-[20px]">
              <div>
                <h2
                  data-aos="fade-up"
                  className="text-white font-extrabold italic text-[16px] sm:text-[25px] lg:text-[30px] 4xl:text-[40px] text-center "
                > .. </h2>

                <div className="mb-[80px] text-white font-bold  space-y-10 w-[95%] mn:w-[340px] sm:w-[495px] md:w-[600px] lg:w-[720px] 1xl:w-[941px] 4xl:w-[1086px] mx-auto mt-[50px] sm:mt-[100px] ">
                  <h2
                    data-aos="fade-up"
                  ...
                  <div className="flex flex-col  justify-center items-center">
                    <div className="fondo_promo w-full h-[180px] sm:h-[280px] md:h-[320px] lg:h-[380px] relative">
                      <img className="absolute w-28 sm:w-36 top-0 right-0" src={oferta} alt="" />
                    </div>
                    <img className="w-[200px] sm:w-[300px] " src={hotmart2} alt="" />
                  </div>
                  <p className="font-medium text-center sm:text-[17px] md:text-[20px]">Por sólo <spam className="text-[#FCB400]">$30</spam> , accede al ebook digital que te da claridad, estructura y acompañamiento real en tu tesis.</p>

                  <h1 className="text-[15px] sm:text-[20px] md:text-[23px] text-center textfinal">Tu <spam className="text-[#0CB2D5]">tesis</spam> no tiene que ser una fuente de
